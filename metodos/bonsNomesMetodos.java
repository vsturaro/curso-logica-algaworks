...
public class bonsNomesMetodos {
        ...
        public static void main(String[] args) {
            ...
            String formaPagamentoEscolhida = receberFormaPagamentoUsuario(scanner);
        ...
        static String receberFormaPagamentoUsuario(Scanner scanner){
            ...
            Integer posicaoFormaPagamentoEscolhida = receberIndeceValidoDoUsuario(formasPagamento, "Sua forma de pagamento escolhida é: ", scanner);
        ...
        static String receberCursoDoUsuario(Scanner scanner){
            ...
            Integer posicaoCursoEscolhido = receberIndeceValidoDoUsuario(cursos, "O curso que você deseja é o: ", scanner);
